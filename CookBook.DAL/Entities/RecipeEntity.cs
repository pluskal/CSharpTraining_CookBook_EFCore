...
namespace CookBook.DAL.Entities
{
    public class RecipeEntity : IEntity
    {
        ...
        public ICollection<IngredientAmount> Ingredients { get; } = new List<IngredientAmount>();
        ...
        private sealed class RecipeEntityEqualityComparer : IEqualityComparer<RecipeEntity>
        {
            public bool Equals(RecipeEntity x, RecipeEntity y)
            {
                ...
                return x.Id.Equals(y.Id) && 
                       ...
                       x.Ingredients.OrderBy(amount => amount.Id).SequenceEqual(y.Ingredients.OrderBy(amount => amount.Id), IngredientAmount.IngredientAmountComparer);
            }
